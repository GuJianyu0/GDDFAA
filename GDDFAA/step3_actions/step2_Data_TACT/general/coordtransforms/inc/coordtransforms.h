...
#define KPC_KMS_10MSUN_UNITS 1 //gjy note: TACT默认用的是这个单位制??
...
#elif KPC_KMS_10MSUN_UNITS
	// 43009.15694; //gjy add; /* in units kpc, km/s and 10^10 M_solar */
	43007.1; //gjy add; /* in units kpc, km/s and 10^10 M_solar */
#elif NATURAL_UNITS
	1.;
#endif
const double FPG = 4.*PI*G; // In Units kpc (km/s) / M_sun
const double masyr2radMyr = 4.8481368111e-3; //"2" is to
...
// Units: velocities in km/s, positions kpc and proper motions in mas/yr //gjy note: units!!!!!!
// ============================================================================
