...
extern void __orbintegz_MOD_main_for_orbit_integrating(double *yy);
extern void __orbintegx_MOD_main_for_orbit_integrating(double *yy);

//
extern void writetofile_release_();
}
